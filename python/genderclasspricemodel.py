...
'''bin fares (brackets)'''
fare_ceiling = 40
data[data[0::,9].astype(np.float) >= fare_ceiling, 9] = fare_ceiling - 1.0 #convert >39 to 39

fare_bracket_size = 10
number_of_price_brackets = fare_ceiling/fare_bracket_size

number_of_classes = len(np.unique(data[0::,2])) #length of an array of unique values in the Pclass column
...
predictions_file = open('C:/Users/Neil/Desktop/Dev/Titanic/python/genderclasspricemodel.csv', 'wb')
